...
# ----------------------
# Loads the csv files, in both csv and json formats
# ----------------------


def loadRandom(location, targetNum=1e5, seed=12345):  # JSON
    random.seed(seed)
    # size of data set
    n = 6685900
...
def loadRandom2(location, targetNum=1e6, seed=12345, n=6000000-1):  # CSV
    random.seed(seed)
